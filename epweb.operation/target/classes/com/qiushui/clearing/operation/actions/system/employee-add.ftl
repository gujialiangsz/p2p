...
<@s.form action="/system/employee-save" class="pageForm required-validate" id="pageForm" onsubmit="if(!checkChar($('#emp_name').val()))return false;return validateCallback(this,dialogAjaxDone)">
<div class="pageFormContent" layoutH="50">
    <fieldset>
        <legend>基本设置</legend>
            <dl style="width: 430px">
                <dt  style="width: 100px">员工号：</dt>
                <dd><@s.input  path="employee.number" size="30" maxlength="6" class="required digits"/></dd>
            </dl>
            <dl style="width: 430px">
            ...
            <dl style="width: 430px">
                ...
                <dd>
                    <input style="width: 633px; height: auto;" name="address" maxlength="64"></input>
                </dd>
            </dl>
         </fieldset>
         <fieldset>
     ...
     <fieldset>
        ...
        <dl style="width: 430px">
            ...
            <dd><@s.input  path="employee.hireDate" size="30" readonly="readonly" class="date required"/></dd>
        </dl>
        <dl style="width: 430px">
        ...
        <dl style="width: 430px">
            ...
            <dd>
                <@s.input  path="employee.workYear" class="digits" size="30" min="0" maxlength="2"/>
           </dd>
        </dl>
        <dl style="width: 430px">
        ...
        <dl style="width: 430px">
            ...
            <dd>
                <textarea style="width: 633px; height: 22px;" name="remark" maxlength="128"></textarea>
            </dd>
        </dl>
    </fieldset>
    </div>
