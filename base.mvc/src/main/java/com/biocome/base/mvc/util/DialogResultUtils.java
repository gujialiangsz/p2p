...
import com.biocome.base.mvc.model.DwzResult;
...
public class DialogResultUtils extends AbstractDwzResultUtils {
	 ...
	 * @description:
	 */
	public static ModelAndView errorNavTab(String message, String navTab) {
		return callback(DwzResult.error(message, navTab));
	}
