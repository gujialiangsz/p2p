...
<div class="pageContent">
     <@s.form action="/system/interface-updateConfigList" id="pageForm" class="pageForm required-validate" onsubmit="return validateCallback(this,dialogReloadDone)"> 
                ...
                <dl style="width: 430px">
                    ...
                    <dd>
                        <select name="isnull" class="required combox">
                            <option value="true" <#if main.isnull>selected="selected"</#if> >是</option>
                            <option value="false" <#if main.isnull==false>selected="selected"</#if>>否</option>
                            <#if https>
                            </#if>
                        </select>
                    </dd>
