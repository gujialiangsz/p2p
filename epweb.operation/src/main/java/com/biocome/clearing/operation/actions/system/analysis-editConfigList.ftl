...
<div class="pageContent">
     <@s.form action="/system/analysis-updateConfigList" id="pageForm" class="pageForm required-validate" onsubmit="return validateCallback(this,dialogReloadDone)"> 
        <div class="pageFormContent" layoutH="54">
            <fieldset style="border:0px;">
                <legend>修改解析配置明细</legend>
                ...
                <dl style="width: 430px">
                    ...
                    <dd>
                        <@s.input path="main.fieldName" class="required alphanumeric"  style="width: 200px" maxlength="20" readonly="readonly"/>
                    </dd>
                </dl>
                <dl style="width: 430px">
