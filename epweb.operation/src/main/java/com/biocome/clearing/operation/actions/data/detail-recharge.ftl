...
<div class="pageHeader">
    <@s.form id="pagerForm" class="pageForm required-validate" action="/data/detail-recharge" onsubmit="if($('#rcstarttime').val()!=''&&$('#rcendtime').val()!=''&&$('#rcstarttime').val()>$('#rcendtime').val()){alertMsg.info('开始日期不能大于结束日期');return false;}return navTabSearch(this);">
       ...
       <div class="searchBar">
            ...
            <ul class="searchContent">
                <li>
                    ...
                    <span>
                        <input type="text" value="${(searchModel.startTime?string("yyyy-MM-dd"))!}" name="startTime"  id="rcstarttime" class="date" />
                        <a class="inputDateButton" href="javascript:;" >选择</a>
                    </span>
                    
                    <span>
                        <input type="text" value="${(searchModel.endTime?string("yyyy-MM-dd"))!}" name="endTime"  id="rcendtime" class="date" />
                        <a class="inputDateButton" href="javascript:;" >选择</a>
                    </span>
                </li>
            </ul>
