<div class="pageContent">
    <@s.form action="/data/device-save" id="pageForm" class="pageForm required-validate" onsubmit="if($('#bluetooth').val()==''){alertMsg.info('请填写蓝牙地址'); return false;} return validateCallback(this,dialogAjaxDone)"> 
        ...
        <dl style="width: 440px">
            ...
            <dd>
                <@s.input path="device.bluetooth" class="required textInput" readonly="readonly" style="width: 200px" id="bluetooth"  maxlength="24"/>
            </dd>
        </dl>
        <dl style="width: 440px">
        ...
        <dl style="width: 440px">
            ...
            <dd>
                <@s.input path="device.deviceSign" class="required textInput"  maxlength="32"/>
            </dd>
        </dl>
        <dl style="width: 440px">
            <dt style="width: 160px">蓝牙密钥：</dt>
            <dd>
                <@s.input path="device.secretKey" class="required textInput"  maxlength="32"/>
            </dd>
        </dl>
        <dl style="width: 440px">
            <dt style="width: 160px">芯片号：</dt>
            <dd>
                 <@s.input path="device.chipNo" class="digits"  maxlength="32"/>
            </dd>
        </dl>
        <dl style="width: 440px">
            <dt style="width: 160px">st版本：</dt>
            <dd>
                <@s.input path="device.st" class="" maxlength="50"/>
            </dd>
        </dl>
        <dl style="width: 440px">
            <dt style="width: 160px">nrf版本：</dt>
            <dd>
                <@s.input path="device.nrf" class="" maxlength="50"/>
            </dd>
        </dl>
    </div>
