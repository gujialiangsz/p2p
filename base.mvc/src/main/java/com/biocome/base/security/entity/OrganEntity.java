...
import com.biocome.base.security.annotations.LogBean;
...
public abstract class OrganEntity<O extends OrganEntity<O, U, A>, U extends UserEntity<U, A, ?>, A extends ActorEntity<O, U, ?>>
	...
	@JoinColumn(name = "parentId", columnDefinition = "varchar(36) comment '上级机构ID'")
	@LogBean(@LogField(text = "上级机构", property = "name"))
	private O parent;
	/** 名称 */
	@NotEmpty
	@LogField(text = "名称")
	@Column(length = 50, columnDefinition = "varchar(50) comment '名称'")
	private String name;
	/** 排序 */
	@LogField(text = "排序")
